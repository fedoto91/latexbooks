...
%% from java.util and also BadGpaException
...
\Tree()
  (2,\underline{Throwable}~~~~				//
   0,\underline{Error}~~~~			
	& 3,\underline{Exception}~~ ~~			//
   2,\underline{RunTimeException}~~ \symbol{40}unchecked\symbol{41} ~~	
        & 0,\underline{BadGpaException}~~ \symbol{40}checked\symbol{41} ~~	
...
Exception classes in the Java class library with our own class,
BadGpaException}


\label {fig:ExceptionClasses2}
