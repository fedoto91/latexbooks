...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Class style   
\tikzstyle{class}=[rectangle,rectangle split, rectangle split parts=3, draw=black, rounded corners, fill=red!40, drop shadow, text centered, anchor=north, text=white, text width=3cm]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Relationship arrow styles%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tikzstyle{g}=[->, >=open triangle 45, thick]%generalization
...
\begin{tikzpicture}[node distance=2cm, auto]
    ...
    \draw[myarrow] (Component) -- ++(0.5,0.8)--(Item);
    \draw[myarrow] (System) -- (Item.center);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Command to define class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\class}[4]{
\node[class] (#1) {<<\textbf #1>> \\ \textbf #2 \nodepart{second}#3 \nodepart{third}#4};
}

\tikz \class{type}{name}{members}{content\\jhjhk\\jh,jhv,\\jm\\};

%%%%%%%draw class diagram%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\classdiagram}[1]{
%parse input by delimeter semi-colon)
\xgetarray{#1}
\tikz [g/.style={gray!50}, font=\bfseries]
\graph[layered layout]{

\foreach \r in {1,...,\xlenarray}{
\getarray{\xgetval{\r}} %grab set located at index \r
[edges=\getval{2}]  %define relationship type
{\getval{3}}->{\getval{1}} %connect 
,
}
}; %end graph
}%
