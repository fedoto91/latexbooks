...
%reset list upon each instantiation%%
	\clearlist{link}           
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \addtolist{link}{#2}
...
\begin{adjustbox}{width=0.8\paperwidth,center,keepaspectratio}
\linklist{3,4,5,6,7,8,{drrt,hgfk},tufik,j0}
\end{adjustbox}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}